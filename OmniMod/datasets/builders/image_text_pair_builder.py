...
from OmniMod.datasets.builders.base_dataset_builder import BaseDatasetBuilder
from OmniMod.datasets.datasets.laion_dataset import LaionDataset
from OmniMod.datasets.datasets.cc_sbu_dataset import CCSBUDataset, CCSBUAlignDataset
from OmniMod.datasets.datasets.text_caps import TextCapDataset
from OmniMod.datasets.datasets.llava_dataset import LlavaDetailDataset, LlavaReasonDataset, LlavaConversationDataset
from OmniMod.datasets.datasets.unnatural_instruction import UnnaturalDataset
from OmniMod.datasets.datasets.multitask_conversation import MultiTaskConversationDataset
from OmniMod.datasets.datasets.flickr import GroundedDetailDataset,CaptionToObjectDataset,PhraseToObjectDataset
from OmniMod.datasets.datasets.vg_dataset import ReferVisualGenomeDataset
from OmniMod.datasets.datasets.coco_dataset import ReferCOCODataset, InvReferCOCODataset
from OmniMod.datasets.datasets.gqa_datasets import GQADataset
from OmniMod.datasets.datasets.aok_vqa_datasets import AOKVQADataset
from OmniMod.datasets.datasets.coco_vqa_datasets import COCOVQADataset
from OmniMod.datasets.datasets.ocrvqa_dataset import OCRVQADataset
from OmniMod.datasets.datasets.coco_caption import COCOCapDataset
...
@registry.register_builder("image_train")
class ImageInstructionBuilder(BaseDatasetBuilder):
    train_dataset_cls = ImageDataset
    eval_dataset_cls = ImageDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/image_instruction/default.yaml",
    }
